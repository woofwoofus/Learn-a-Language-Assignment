...
//      System.out.println(e.numberOfKills); NumberOfKills is a private int and thus not visible outside of the class it's created in.
      ...
      a.talk();
//      a.fly(); 
//      Doesn't work because 'a = b' only creates a pointer to the bird class rather than turning it into one when trying to change it to a subclass.
      
//      b = a; 
//      Doesn't work because without specifically casting the variable as an Animal, the operation will fail to run.
      b.talk();
      b.fly();
